...
type Config struct {
	ApiRouterLoggerFormat string   `env:"ROUTER_LOGGER_FORMAT" envDefault:"{\"severity\": \"INFO\", \"time\": \"${time}\", \"level\":\"info\", \"source\": \"router\", \"path\": \"${routePath}\", \"url\": \"${url}\", \"method\": \"${method}\"}\n"`
